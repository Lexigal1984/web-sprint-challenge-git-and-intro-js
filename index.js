...
function addArtist(arr, name, years, genre, nationality, bio) {
  const newartistsarray = [...arr]
  newartistsarray.push({
    name, 
    years,
    genre, 
    nationality,
...
console.log(addArtist(artists, 'Jane Smith', '1984 - 2023', 'North American', 'German', 'Jane Smith, has done many things throughout her life. Never gave up on her dreams.'))
